## ax7010_platformer.xdc
## Pin constraints for the AX7010 (XC7Z010-1CLG400C) 2D Platformer project.
## Identical pinout to project01_pong / project02_textmode (same board, same
## HDMI connector, same buttons); pins originally verified against ALINX's
...
## key[0]=walk left  key[1]=walk right  key[2]=jump  key[3]=run (hold)
